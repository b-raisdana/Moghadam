...
if __name__ == "__main__":
    ...
    read_multi_timeframe_peaks_n_valleys(config.under_process_date_range)
    date_range_str = config.under_process_date_range
    file_path = config.path_of_data
    # MT.extract_to_data_path(os.path.join(os.getcwd(), file_path, f'multi_timeframe_peaks_n_valleys.{date_range_str}.zip'))
    MT.run_by_autoit()
